...
<body>
  ...
  <div class="container">
    ...
    <form id="chooseCategory" class="text-center">


          <input type="checkbox" id="history" value="1"><input type="checkbox" id="astronomy" value="1"><input type="checkbox" id="physics" value="1"><input type="checkbox" id="computer" value="1">

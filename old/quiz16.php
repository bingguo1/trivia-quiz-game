...
<body>
  ...
  $(document).ready(function() {
    ...
    $("#start2").click(function(){
      ...
      if($('#history').prop('checked')) str+=" (category>9 AND category<20) OR ";
      if($('#astronomy').prop('checked')) str+=" (category>19 AND category<30) OR ";
      if($('#physics').prop('checked')) str+=" (category>29 AND category<40) OR ";
      if($('#computer').prop('checked')) str+=" (category>39 AND category<50) OR ";
      if($('#politics').prop('checked')) str+=" (category>49 AND category<60) OR ";
      if($('#life').prop('checked')) str+=" (category>59 AND category<70) OR ";
      if($('#biology').prop('checked')) str+=" (category>69 AND category<80) OR ";
      if($('#geography').prop('checked')) str+=" (category>79 AND category<90) OR ";
      str+=" (category<0)";
      var stringArr=[];
